...
def create_admin_user():
    """
    Create an admin user interactively or using environment variables.
    """
    ...
    # Get username from input if not from environment
    if not username:
        while True:
    ...
    # Get email from input if not from environment
    if not email:
        while True:
    ...
    # Get password from input if not from environment
    if not password:
        while True:
