        ...
        try:
            ...
            if is_video:
                if VIDEO_PASSTHROUGH_ASR:
                    ...
                    if VIDEO_RETENTION:
                        # Also keep the video for playback, but preserve the existing persistent locator.
                        recording.mime_type = mimetypes.guess_type(original_filename or filepath)[0] or 'video/mp4'
                        db.session.commit()
