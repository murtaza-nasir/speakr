-- Schema of Speakr v0.10.3-alpha, generated from that tag's own models.
-- Regenerate with scripts/generate_schema_fixtures.py. Do not hand-edit.
-- user table: 41 columns
...
CREATE TABLE user (
	...
	parse_filename_dates BOOLEAN, 
	filename_date_pattern VARCHAR(50), 
	filename_date_regex VARCHAR(500), 
	export_filename_template VARCHAR(500), 
